...
╭─❒ 「 *RADITYA BOT* 」 
├ *天Creator :  @${koko.split('@')[0]}*
├ *天Powered  : @${ini_mark.split('@')[0]}*
├ *天Prefix :   ${prefix}*
├ *天Total hit : ${require('util').inspect(hitall(sender))}*
├ *天Hit today : ${hit_today.length}*
├ *天Speed : ${latensii.toFixed(4)} Second*
├ *天Hostname : ${os.hostname()}*
├ *天Platform : ${os.platform()}*
├ *天Runtime : ${(kyun(os.uptime()))}*
├ *天Battery : ${isBattre}*
╰❒ *天Charging : ${isCharge}*
